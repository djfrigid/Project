...
def normalise_input(user_input): #done
...
def exit_leads_to(exits, direction): #done
    ...
    roomData = exits[direction]
    if roomData == "Tutor":
        print('''"your personal tutor's office"''')
    elif roomData == "Admins":
        print('''"MJ and Simon's room"''')
    else:
        print("""'""" + roomData + """'""")
    

def print_menu_line(direction, leads_to): #done
